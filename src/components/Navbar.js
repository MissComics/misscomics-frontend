          ...
          <div className="relative group">
            {pinnedBurgerItem ? (
              <button
                ...
                <Pin className="h-4 w-4 transform rotate-45 text-purple-400" />
              </button>
            ) : (
          ...
          <div className="relative" ref={settingsRef}>
            <button
              ...
              className="text-gray-500 hover:text-white transition p-2.5
                         rounded-xl hover:bg-gray-900 flex items-center justify-center"
              aria-label="Settings">
              <Settings className={`w-5 h-5 stroke-[1.8] transition-transform duration-500 ${settingsOpen ? 'rotate-90 text-purple-400' : ''}`} />
            </button>
