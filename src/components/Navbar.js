...
function BurgerIcon({ isOpen }) {
  ...
  return (
    <div className="relative w-9 h-9">
      ...
      {/* ── CHEESE ── */}
      <svg
        className={`${base} ${isOpen ? "-translate-y-[4px] -rotate-[3deg]" : "top-[23px]"} h-[8px]`}
        viewBox="0 0 244 242"
        xmlns="http://www.w3.org/2000/svg"
        style={{ transition: "all 450ms cubic-bezier(0.34,1.56,0.64,1)" }}
      >
      ...
      {/* ── PATTY ── */}
      <svg
        className={`${base} ${isOpen ? "translate-y-[4px] rotate-[3deg]" : "top-[30px]"} h-[10px]`}
        viewBox="0 0 244 242"
        xmlns="http://www.w3.org/2000/svg"
        style={{ transition: "all 450ms cubic-bezier(0.34,1.56,0.64,1)" }}
      >
      ...
      {/* ── TOMATO ── */}
      <svg
        className={`${base} ${isOpen ? "translate-y-[10px] -rotate-[4deg]" : "top-[39px]"} h-[8px]`}
        viewBox="0 0 244 242"
        xmlns="http://www.w3.org/2000/svg"
        style={{ transition: "all 450ms cubic-bezier(0.34,1.56,0.64,1)" }}
      >
      ...
      {/* ── BOTTOM BUN ── */}
      <svg
        className={`${base} ${isOpen ? "translate-y-[18px] rotate-[8deg]" : "top-[46px]"} h-[14px]`}
        viewBox="0 0 244 242"
        xmlns="http://www.w3.org/2000/svg"
        style={{ transition: "all 450ms cubic-bezier(0.34,1.56,0.64,1)" }}
      >
